...
scale.min = min(c(DJF.cf1, MAM.cf1, JJA.cf1, SON.cf1,
                  DJF.cf2, MAM.cf2, JJA.cf2, SON.cf2), na.rm = TRUE)
scale.max = max(c(DJF.cf1, MAM.cf1, JJA.cf1, SON.cf1,
                  DJF.cf2, MAM.cf2, JJA.cf2, SON.cf2), na.rm = TRUE)
...
ann <- annotate_figure(g, top = text_grob(paste0("Change in seasonal average ", long.title), 
                                      face = "bold", size = 20))
