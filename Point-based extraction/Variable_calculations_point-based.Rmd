...
## If you are using point-based (centroid) extraction, run this code
source(here::here("Code", "Metric-development", "met","Annual.tmeanF_point-based.R"),echo = FALSE)
## If you are using spatial extraction, run this code
# source(here::here("Code", "Metric-development", "met","Annual.precipIn.R"),echo = FALSE)
## If you are using point-based (centroid) extraction, run this code
source(here::here("Code", "Metric-development", "met","Annual.precipIn_point-based.R"),echo = FALSE)
...
## If you are using point-based (centroid) extraction, run this code
source(here::here("Code", "Metric-development", "vic","SWE-runoff-Pr99_point-based.R"),echo = FALSE)
